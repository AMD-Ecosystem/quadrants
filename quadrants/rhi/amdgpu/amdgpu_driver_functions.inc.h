...
// hipMallocAsync/hipFreeAsync require ROCm >= 5.4. Wrapped by
// AMDGPUDriver::malloc_async (in amdgpu_driver.cpp) which falls back to
// synchronous hipMalloc when the device does not support memory pools.
...
// Wrapped by AMDGPUDriver::mem_free_async (in amdgpu_driver.cpp) — see comment
// on malloc_async_impl above.
