...
class TaskCodeGenLLVM : public IRVisitor, public LLVMModuleBuilder {
 public:
  ...
  // On AMDGPU, byval attribute is disallowed by the calling convention verifier. Instead, pass the struct type
  // directly in kernarg and store to an alloca at function entry to obtain a pointer.
